...
@Getter
public class EditPostResponseDto extends ResponseDto {

    private EditPostResponseDto() {
        super(ResponseCode.SUCCESS, ResponseMessage.SUCCESS);
    }

    public static ResponseEntity<EditPostResponseDto> success() {
        EditPostResponseDto result = new EditPostResponseDto();
